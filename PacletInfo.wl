...
PacletObject[
  <|
    "Name" -> "AntonAntonov/DataReshapers",
    "Description" -> "Data reshaping functions",
    ...
    "Extensions" -> {
      {
        "Kernel",
        "Root" -> "Kernel",
        "Context" -> {"AntonAntonov`DataReshapers`"},
        "Symbols" -> {
          "AntonAntonov`DataReshapers`CrossTabulate",
          ...
          "AntonAntonov`DataReshapers`RecordsSummary",
